...
<AnalysisCarousel
  basePath="/static/images/articles/extras/mfichajes"
  images={['s-4.png', 's-5.png', 's-6.png', 's-7.png', 's-8.png', 's-9.png', 's-10.png']}
/>
...
**Álex Baena** al Atlético de Madrid por 42 millones de euros fijos más 13 millones en variables. He dudado entre él y Mikautadze, y finalmente me he decantado por el georgiano, porque la proxiam semana tendréis un análisis exhaustivo del urcitano, que ya vuelve de su lesión y cuya evolución lo posiciona como uno de los mediapuntas más determinantes de Europa.
