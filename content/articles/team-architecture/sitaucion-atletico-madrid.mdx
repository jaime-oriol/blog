...
<Image
  src="/static/images/articles/atm/J3-situacion/PN-Espanyol-2.png"
  alt="Pass Network del Atlético de Madrid vs Espanyol - Primera y segunda parte"
  width={800}
  height={600}
  caption="Evolución del pass network rojiblanco: dominio en la primera parte vs fragmentación en el segundo tiempo"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/PN-Elche-2.png"
  alt="Pass Network del Atlético de Madrid vs Elche - Primera y segunda parte"
  width={800}
  height={600}
  caption="Pass network disperso del Atlético ante la masterclass táctica de Eder Sarabia"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/PN-Alaves-2.png"
  alt="Pass Network del Atlético de Madrid vs Alavés - Primera y segunda parte"
  width={800}
  height={600}
  caption="La deriva definitiva: conexiones débiles y delanteros desconectados en Vitoria"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/SM-Espanyol-ATM.png"
  alt="Shot Map Espanyol vs Atlético de Madrid"
  width={800}
  height={500}
  caption="Mapa de disparos vs Espanyol: ocasiones claras desperdiciadas"
/>

<Image
  src="/static/images/articles/atm/J3-situacion/SM-ATM-Elche.png"
  alt="Shot Map Atlético de Madrid vs Elche"
  width={800}
  height={500}
  caption="Mapa de disparos vs Elche: dominio territorial sin efectividad"
/>

<Image
  src="/static/images/articles/atm/J3-situacion/SM-Alaves-ATM.png"
  alt="Shot Map Alavés vs Atlético de Madrid"
  width={800}
  height={500}
  caption="Mapa de disparos vs Alavés: la versión más pobre del ataque rojiblanco"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/shots.png"
  alt="Shot Map comparativo agregado - Atlético vs Rivales"
  width={900}
  height={600}
  caption="Contraste demoledor: más disparos y xG para el Atlético, mayor efectividad para los rivales"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Oblak.png"
  alt="Radar estadístico de Jan Oblak"
  width={700}
  height={700}
  caption="Jan Oblak - El declive de un portero de élite: PSxG de -1.4 en solo tres partidos"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_LeNormand.png"
  alt="Radar estadístico de Robin Le Normand"
  width={700}
  height={700}
  caption="Robin Le Normand - Perfil desconcertante: evita el duelo directo con solo 42% en duelos aéreos"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Hancko.png"
  alt="Radar estadístico de David Hancko"
  width={700}
  height={700}
  caption="David Hancko - El contraste revelador: anticipa donde Le Normand reacciona"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Almada.png"
  alt="Radar estadístico de Thiago Almada"
  width={700}
  height={700}
  caption="Thiago Almada - El único elemento consistentemente funcional: sobrecargado pero productivo"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Baena.png"
  alt="Radar estadístico de Álex Baena"
  width={700}
  height={700}
  caption="Álex Baena - Masterclass en 67 minutos: percentil 98 en Expected Assists"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Julian.png"
  alt="Radar estadístico de Julián Álvarez"
  width={700}
  height={700}
  caption="Julián Álvarez - Desperdicio de 75 millones: ni '9' puro ni creador diferencial"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_Sorloth.png"
  alt="Radar estadístico de Alexander Sørloth"
  width={700}
  height={700}
  caption="Alexander Sørloth - La paradoja estadística: números élite sin impacto real"
/>
...
<Image
  src="/static/images/articles/atm/J3-situacion/Radar_ATM.png"
  alt="Radar estadístico del Atlético de Madrid - Equipo"
  width={700}
  height={700}
  caption="Atlético de Madrid - Radar colectivo: posesión sin amenaza, progresión sin finalización"
/>
