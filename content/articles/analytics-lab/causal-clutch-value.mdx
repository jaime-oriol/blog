...
<Image
  src="/static/images/articles/ccv/radar_report_mbappe.png"
  alt="Scout-facing de Mbappé"
  width={1200}
  height={700}
  caption="Ficha scout-facing de Kylian Mbappé. Radar de doce ejes representando cuatro canales de desempeño (ofensivo, defensivo, off-ball, físico) × tres contextos de shock (gol a favor, gol en contra, proximidad eliminación). Mbappé muestra dominio absoluto en los cuadrantes ofensivos y off-ball bajo presión."
/>
